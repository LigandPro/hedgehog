...
from hedgehog.vendor.moleval.metrics.fcd_torch import FCD as FCDMetric
from hedgehog.vendor.moleval.metrics.metrics_utils import mapper
from hedgehog.vendor.moleval.metrics.metrics_utils import SillyWalks
from hedgehog.vendor.moleval.metrics.metrics_utils import SA, QED, NP, weight, logP
...
class GetMetrics(object):
    ...
    def __init__(self, n_jobs=1, device='cpu', batch_size=512, pool=None,
        ...
        # Clean up invalid smiles in reference sets
