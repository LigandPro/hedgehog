...
def _get_aizynthfinder_config() -> Path:
    ...
    return project_root / 'modules' / 'retrosynthesis' / 'aizynthfinder' / 'public' / 'config.yml'
...
def main(config: dict) -> None:
    ...
    if not run_aizynthfinder(output_folder / 'input_smiles.smi', output_json, aizynth_config):
