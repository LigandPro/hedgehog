    ...
    cells = [
        ...
        _code_cell(
            ...
            STAGE_SPECS = {
                ...
                "mol_prep": {
                    "label": "Mol Prep",
                    "detail": ["stages/00_mol_prep/filtered_molecules.csv"],
                    "filtered": ["stages/00_mol_prep/filtered_molecules.csv"],
                    "failed": ["stages/00_mol_prep/failed_molecules.csv"],
                    "previous": "input",
                },
                "descriptors_initial": {
                    ...
                    "detail": [
                        ...
                        "stages/01_descriptors_initial/filtered_molecules.csv",
                    ],
                    "filtered": [
                    ...
                    "failed": [
                        "stages/01_descriptors_initial/filtered/descriptors_failed.csv",
                        "stages/01_descriptors_initial/filtered/failed_molecules.csv",
                        "stages/01_descriptors_initial/failed_molecules.csv",
                    ],
                    "previous": "mol_prep",
                },
                "struct_filters_post": {
