...
const DESCRIPTORS_PARAMS: ParamDef[] = [
  ...
  { key: 'fraction_ring_system', label: 'Fraction Ring System', type: 'range', minKey: 'fraction_ring_system_min', maxKey: 'fraction_ring_system_max', configPath: ['borders'], description: 'Murcko scaffold heavy atoms / total heavy atoms' },
  { key: 'has_spider_side_chains', label: 'Spider Side Chains', type: 'range', minKey: 'has_spider_side_chains_min', maxKey: 'has_spider_side_chains_max', configPath: ['borders'], description: '0 rejects molecules with two or more long scaffold appendages' },
...
const DOCKING_PARAMS: ParamDef[] = [
  ...
  { key: 'tools', label: 'Tool', type: 'select', options: ['all', 'smina', 'gnina', 'matcha'], description: 'Use all engines or select one here; multi-engine subsets can be set manually in YAML' },
...
export function QuickConfig({ stageName }: QuickConfigProps): React.ReactElement {
  ...
  const syncDescriptorQuickParams = (configData: Record<string, unknown>): void => {
    ...
    const descriptorParams = [
      ...
      'logP_min',
      'logP_max',
      'fraction_ring_system_min',
      'fraction_ring_system_max',
      'has_spider_side_chains_min',
      'has_spider_side_chains_max',
      'max_n_or_o_atoms',
      'max_small_rings_3_4',
