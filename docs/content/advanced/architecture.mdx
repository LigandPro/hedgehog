...
Create `src/hedgehog/configs/<my_stage_config>.yml`:
...
```yaml
# In config.yml
config_<my_stage>: src/hedgehog/configs/<my_stage_config>.yml
```
...
CONFIG_MY_STAGE = "config_<my_stage>"
