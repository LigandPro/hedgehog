...
HEDGEHOG creates IDs in the form `LP-000M-0000N`, scoped by `model_name`, with `M` for *model name* and `N` for *molecule number*.
...
Filtering stages write a stable `filtered_molecules.csv`:
