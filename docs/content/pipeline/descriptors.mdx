...
Inventum-inspired structural constraints such as typed atom class limits,
...
|-----------|------------|-------------|---------|
| Typed Atom Class Limits | `structural_constraints.type_limits` | Maximum allowed counts for Inventum-style aliases such as `.=O`, `Car`, `Nd+`, `O_a`, `SO2`, `Hal` | See YAML |
...
structural_constraints:
  enabled: true
  # ... typed atom class limits and structural caps
borders:
