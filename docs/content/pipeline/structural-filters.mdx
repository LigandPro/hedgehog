...
The shipped config also contains several commented-out optional rulesets
(`Toxicophore`, `Skin`, `Reactive-Unstable-Toxic`, `Electrophilic`,
`Genotoxic-Carcinogenicity`, and `Non-Genotoxic-Carcinogenicity`). They are
examples you can enable deliberately; they are not active by default.
