...
| `run_sync` | bool | `true` | Compute the 3D SYNC synthesizability classifier score |
...
| `sync_score_min` | float | `0.5` | Minimum SYNC synthesizability probability |
| `sync_score_max` | float | `1` | Maximum SYNC synthesizability probability |
