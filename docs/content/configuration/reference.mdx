...
Controls molecular docking using SMINA, GNINA, Matcha, or both. Defines the receptor, search box, and engine-specific parameters.
...
| `tools` | string | `gnina` | Docking engine: `gnina`, `smina`, `matcha`, or `both` |
