...
| `config_descriptors.yml` | Descriptor calculation and active filtering borders |
| `config_structFilters.yml` | Structural alerts; `calculate_*` vs `filter_*`; Common Alerts calculate/enforce lists; profiles: default / exploration / strict |
