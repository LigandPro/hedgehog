...
- **7-stage evaluation pipeline** — molecules pass through descriptors, structural filters, synthesis evaluation, docking, docking filters, and final descriptor recalculation, with an optional pre-descriptors filtering step for early elimination of problematic structures.
...
- **Automated reporting** — interactive HTML report with molecule retention funnel, descriptor distributions, filter breakdowns, docking results, MolEval generative metrics, drug-likeness compliance, and chemical group presence analysis.
