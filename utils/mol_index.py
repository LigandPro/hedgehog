...
def assign_mol_idx(df: pd.DataFrame, run_base: Path, logger: Optional[object] = None) -> pd.DataFrame:
    """
    ...
    # Build per-run model mapping (preserves appearance order)
